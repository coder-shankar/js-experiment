...
class PipePair {
    ...
    createPipe() {
        ...
        this.pipeUp.height = random(100, 300);
...
class Game {
    ...
    collide() {
        ...
        pipeCollection.forEach(pipe => {

            let pipeD = pipe.pipeDown;
            let pipeU = pipe.pipeUp;

            if ((bird.x + bird.width > pipeU.x && bird.y + bird.width < pipeU.height) || (bird.x + bird.width > pipeD.x && bird.y > pipeU.height + 80) || (bird.y + bird.width > 500)) {
